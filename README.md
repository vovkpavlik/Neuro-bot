...
- При необходимости, добавьте боту новые темы для разговора, добавляйте их во вкладке _Intents_, либо запишите новые инструкции в файл с расширением `.json`, дав ему имя "intents", и перенесите его в корневой каталог вашего проекта.
